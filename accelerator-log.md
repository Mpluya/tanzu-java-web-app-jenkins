...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=Mpluya&repo=tanzu-java-web-app-jenkins",
  "projectName" : "tanzu-java-web-app-jenkins",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-j...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=tanzu-java-web-app-jenkins'
